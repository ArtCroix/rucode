    ...
    return (
      <footer className="footer container-fluid mx-0">
        <div className="footer__container row no-gutters align-items-center my-2 mx-auto">
          <div class="col-sm-4 col-12 mr-auto mr-auto mr-sm-auto ml-sm-0 text-white">
          ...
          <div class="col-sm-1 text-center text-sm-right ml-auto"></div>
          <div class="row align-items-center justify-content-between justify-content-sm-start no-gutter">
            <div class="col-sm-6 col-3 text-center">
              <img
                className="img-fluid"
